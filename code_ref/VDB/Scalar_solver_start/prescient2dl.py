...
# folders = "F:\\instances_output"
selected_folders = folders
# selected_folders = ["instances_output_0000000000-0000000999"]
# selected_folders.remove('instances_output_0000000000-0000000499')
# selected_folders.remove('instances_output_0000000499-0000000999')
# selected_folders.remove('instances_output_0000001000-0000001499')
# selected_folders.remove('instances_output_0000001499-0000001999')
# selected_folders.remove('instances_output_0000002000-0000002499')
# selected_folders.remove('instances_output_0000002500-0000002999')

# Split the dataset into training and validation sets
sample = np.load('F:\\instances_output_0000000000-0000000499\\instance_0000000000_o.npy')
